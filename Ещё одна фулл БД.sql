...
INSERT INTO `specialty_code` VALUES (109,'Программисты'),(110,'Автомеханики');
...
) ENGINE=InnoDB AUTO_INCREMENT=3670 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student` VALUES (1,'Муратов С.С.','28.02.1998','24Вб',109,'80912840','serg@mail.ru'),(3666,'Дубцова С.А.','21.04.2003','24Вб',109,'36293875','sofa@abc.com'),(3668,'Иванов И.И.','13.12.2001','24Вб',109,'892435982','oisn@asdf.ru'),(3669,'Петров П.П.','31.02.2003','24Вб',109,'123124125','afsaf@asdf.ru');
...
INSERT INTO `student_additional_info` VALUES ('Дополнительная информация','Английский','Да','Дополнительные компетиции','вконтакте.ру',1),('Доп','Английский','Нет','Доп','одноклассники.ру',3668),('Доп','Английский, немеций','Нет','Доп','тик-ток.ру',3666);
...
INSERT INTO `student_education` VALUES (1,'Колледж до связи №54','Инофрмационные системы и программирование','Очная','2024','Москва'),(3668,'Колледж до связи №54','Инофрмационные системы и программирование','Очная','2024','Москва');
...
INSERT INTO `student_photo` VALUES (3668,_binary 'ФОТО'),(1,_binary 'Photo');
...
INSERT INTO `student_soft_skills` VALUES (1,'Самостоятельность','Общительность','Навыки презентации','Командная работа','Пунктуальность');
